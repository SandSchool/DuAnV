...
<section class="hero-section">
    <div class="container">
        <h1 class="hero-title">Khám Phá Tất Cả Sản Phẩm</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-4">
                <div class="filter-card">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="category-sport">
                            <label class="form-check-label" for="category-sport">Giày Thể Thao</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="category-office">
                            <label class="form-check-label" for="category-office">Giày Công Sở</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="category-outdoor">
                            <label class="form-check-label" for="category-outdoor">Giày Outdoor</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="category-fashion">
                            <label class="form-check-label" for="category-fashion">Giày Thời Trang</label>
                        </div>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="brand-puma">
                            <label class="form-check-label" for="brand-puma">Puma</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="brand-converse">
                            <label class="form-check-label" for="brand-converse">Converse</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="brand-vans">
                            <label class="form-check-label" for="brand-vans">Vans</label>
                        </div>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <div class="price-range">
                            <input type="range" class="form-range" min="0" max="10000000" step="500000" value="5000000">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="size-buttons">
                            ...
                            <button type="button" class="btn btn-outline-secondary btn-size">{{ $size }}</button>
                            @endforeach
                        </div>
                    </div>

                    <button class="btn btn-primary w-100 mt-3">Áp Dụng Bộ Lọc</button>
                </div>
            </div>
            ...
            <div class="col-lg-9">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <p class="mb-0">Hiển thị <strong>1-12</strong> trên <strong>48</strong> sản phẩm</p>
                    <div class="sort-dropdown">
                        <select class="form-select">
                            <option selected>Sắp xếp: Phổ biến nhất</option>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card product-card">
                            <span class="product-badge">{{ $product->badge ?? 'HOT' }}</span>
